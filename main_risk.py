...
if __name__ == '__main__':
    ...
    cd, td, ad = sms.disclosure_calc(bk_type,uniq_act,measurement_type, bk_length, existence_based, mult_log, tuple_log, traces_char, simple_log_char, multiprocess=multiprocess)
